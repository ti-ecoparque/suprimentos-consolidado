...
# Adicionamos o parâmetro opcional 'container_botao' para injetar o botão no local certo lá de cima
def renderizar_grid_multiindex_colorido(df_final, lista_entrega_dt_bruta, lista_necessidade_dt_bruta):
    ...
    # 🚨 O BOTÃO SÓ SE POSICIONA SE A CONSULTA CONCLUIR COM SUCESSO
    st.download_button(
